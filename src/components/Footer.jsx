    ...
    <footer className="bg-gray-100 p-6 bg-indigo-950 rounded-lg">
      <div className="container mx-auto">
        <div className='bg-white'>
            ...
            <button className='bg-blue-900 text-white px-4 h-10 rounded mt-4 border-b-7 border-0'>
                <div className='flex flex-row'>
                    <img src={apple} alt="App Store" className="mr-4 w-[40px] h-[40px]" />
                    <span className='p-2 text-white text-xl'>App Store</span> 
                </div>
            </button>
        ...
        <div className="text-white flex flex-row text-center mt-4">
          <p>&copy; 2022 Medicare</p>
          <p>Design & Developed by MUSEMIND Agency</p>
        </div>
      </div>
    </footer>
  );
